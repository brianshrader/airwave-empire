...
(function (global) {
  ...
  var PALETTES = {
    ...
    oldies: [
      { bg: '#4e342e', fg: '#fff8e1', ac: '#ffb74d', ac2: '#6d4c41' },
      { bg: '#3e2723', fg: '#ffe0b2', ac: '#ff7043', ac2: '#5d4037' },
      { bg: '#212121', fg: '#fffde7', ac: '#ffd54f', ac2: '#616161' },
      { bg: '#5d4037', fg: '#ffecb3', ac: '#d84315', ac2: '#8d6e63' },
    ],
    urban: [
  ...
  var TYPOGRAPHY_BY_FAMILY = {
    ...
    sports: {
      trackingPrimaryEm: -0.04,
      trackingSecondaryEm: -0.03,
    ...
    oldies: {
      trackingPrimaryEm: 0.03,
      trackingSecondaryEm: 0.022,
      weightPrimaryDelta: 40,
      weightSecondaryDelta: 0,
      italicPrimaryMax: 20,
      italicSecondaryMax: 0,
      hierarchyBias: 'calls',
      primaryLineScale: 1.04,
      secondaryLineScale: 1.14,
      singleScale: 1.15,
      hierarchyGap: 1.08,
      heroAlign: 'center',
      heroAlignRotate: 'left',
      casing: 'upper',
      thumbBrandScale: 1.05,
      thumbCallScale: 1.03,
      thumbFreqScale: 1.0,
    },
    urban: {
