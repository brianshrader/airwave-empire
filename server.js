...
// Image API: SHORTAPI_KEY (ShortAPI flux-1.0 or z-image via SHORTAPI_IMAGE_MODEL) and/or GROK_API_KEY for /api/generate-logo, /api/generate-remote-van (Grok edit + logo reference), and AI portraits.
...
// Logo example: SHORTAPI_IMAGE_MODEL=shortapi/flux-1.0/text-to-image  SHORTAPI_FLUX_PERFORMANCE=dev
...
const { SAVES_DIR, ensureDir } = require('./server/runtimePaths');
